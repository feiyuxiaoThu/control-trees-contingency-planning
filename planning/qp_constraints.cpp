 ...
 * @Date: 2025-09-07 15:42:54
 * @LastEditors: puyu yu.pu@qq.com
 * @LastEditTime: 2025-09-07 15:46:53
 * @FilePath: /dive-into-contingency-planning/planning/qp_constraints.cpp
 * Copyright (c) 2025 by puyu, All Rights Reserved.
 */

#include "planning/qp_constraints.hpp"

bool Constraints::validate() const { return varss.size() >= xmaxs.size(); }

Eigen::MatrixXd Constraints::getSextract() const {
    ...
    Eigen::MatrixXd Sextract = Eigen::MatrixXd::Zero(active_rows.size(), 2 * n_steps);
...
Eigen::VectorXd Constraints::getXmax() const {
    Eigen::MatrixXd Xmax =
        Eigen::VectorXd::Constant(2 * n_steps, std::numeric_limits<double>::max());
